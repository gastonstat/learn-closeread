...
With the URL of the image, you can insert the logo in a quarto document with the 
...
directory, and insert it into a quarto document with a similar syntax, 
for example:
...
__Caption.__ Inside the brackets, you can add an optional caption:
