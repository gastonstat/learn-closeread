...
Until one day, the boundary gives way. @cr-phd9

:::{#cr-phd9}
![](phd_009.jpg){width="120%" height="120%"}
:::


And, that dent you've made is called a Ph.D. @cr-phd10

:::{#cr-phd10}
![](phd_010.jpg){width="120%" height="120%"}
:::


Of course, the world looks different to you now. @cr-phd11

:::{#cr-phd11}
![](phd_011.jpg){width="120%" height="120%"}
:::
...
Code: <a href="https://github.com/gastonstat/learn-closeread/blob/main/examples/example4/index.qmd" target="_blank">github repo</a>
