...
format: 
  closeread-html:
    ...
    cr-style:
      ...
      narrative-background-color-overlay: "#7c7c7cdd"
...
about the number of tropical storms per year that occurred in the North 
Atlantic between 1980 and 2022? @cr-plot1
...
In the 2010's the trend seemed to slow down a bit with an average number of 
storms per year of `r storms_per_decade[4,2]`  @cr-plot5
