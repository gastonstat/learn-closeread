...
hexcolor = "#f59745" # highlight color per decade
maxcolor = "#d14b13" # color of maximum
```
...
How many tropical storms per year occurred in the North Atlantic between 1980 and 2022? @cr-plot1
...
colors1 = c(rep(hexcolor, 10), rep("#90909000", 33))
...
colors2 = c(rep("#bbbbbb", 10), rep(hexcolor, 10), rep("#90909000", 23))
...
colors3 = c(rep("#bbbbbb", 20), rep(hexcolor, 10), rep("#90909000", 13))
...
colors4 = c(rep("#bbbbbb", 30), rep(hexcolor, 10), rep("#90909000", 3))
...
colors5 = c(rep("#bbbbbb", 40), rep(hexcolor, 3))
...
storms_per_year |> 
  ggplot(aes(x = year, y = count)) +
  geom_col(fill = "#bbbbbb") +
  geom_smooth(se = FALSE, linewidth = 1.4, color = hexcolor) +
  scale_x_continuous(breaks = seq(1980, 2020, by = 5)) +
  theme_minimal() +
  labs(title = "Number of Storms per Year in the North Atlantic",
       x = "")
